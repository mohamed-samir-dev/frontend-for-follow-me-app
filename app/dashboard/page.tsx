...
import { Server, CheckCircle, XCircle, AlertTriangle, ArrowRight } from "lucide-react";
import Link from "next/link";
import { getStats, getServices, updateService, deleteService } from "@/lib/api";
...
export default function DashboardPage() {
  ...
  const fetchData = async () => {
    try {
      const [s, r] = await Promise.all([getStats(), getServices({ sort: "renewal" })]);
      setStats(s.data);
